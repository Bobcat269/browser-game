...
function makeFood(x) {
  if (
    ...
    game.money += Number(game.meals[0].price);
    game.meals[0].sold++;
  } else if (
    x === 1 &&
    game.ingredients[1].stock > 0 &&
    ...
    game.money += Number(game.meals[1].price);
    game.meals[1].sold++;
  } else if (
    x === 2 &&
    game.ingredients[0].stock > 0 &&
    ...
    game.money += Number(game.meals[2].price);
    game.meals[2].sold++;
  }
}
...
function dinnerTime() {
  ...
  if (game.day <= 10) {
    ...
    dayCounter.textContent = game.day;
    postCart();
    game.day++;
  } else {
...
buttonElements.forEach((button) => {
  button.addEventListener(`click`, (event) => {
    ...
    if (button.textContent === "+") {
      ...
      if (game.money >= game.ingredients[rowID - 1].price) {
        //gotta have money to buy
